...
import {HiEye,HiTrash,HiArrowDownOnSquare,HiArrowUpOnSquare} from 'react-icons/hi2';
...
export default function BookingRow({booking:{id: bookingId,created_at,startDate,endDate,numNights,numGuests,totalPrice,status,guests:{ fullName:guestName,email},cabins: {name:cabinName}}}){
        ...
        <Modal>
            <Menus.Menu>
                ...
                <Menus.List id={bookingId} >
                    ...
                    {status === 'checked-in' && <Menus.Button onClick={() => checkout(bookingId)} disabled={isCheckout} icon={<HiArrowUpOnSquare />} >
                        Check-out
                    </Menus.Button>}
                    {status === 'unconfirmed' && <Menus.Button onClick={() => navigate(`/checkin/${bookingId}`)} icon={<HiArrowDownOnSquare />} >
                        Check-in
                    </Menus.Button>}
